...
FIELDS: dict[str, dict] = {
    ...
    # --- Performance ---
    "min_star_rate"        : {"section": "performance", "type": float, "label": "Минимальный курс звезды фрагмент",    "hint": "Например: 1.15"},
    "min_star_rate_gifts"  : {"section": "performance", "type": float, "label": "Минимальный курс звезды подарками",    "hint": "Например: 1.20"},
    ...
    "hello_cooldown"       : {"section": "performance", "type": int,   "label": "КД на приветствие",          "hint": "Например: 1000"},
